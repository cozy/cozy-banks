...
it('should prepare transactions for the template', function () {
  ...
  // date -> [key, values]
  expect(prepared.isa1[0][0]).toBe('2012-08-02')
  expect(prepared.isa1[0][1][0].label).toBe('1')
  expect(prepared.isa1[1][1][0].label).toBe('2')
  expect(prepared.isa1[1][1][1].label).toBe('3')
  expect(prepared.isa1[2][1][0].label).toBe('4')
})
